...
void GameHandler::resetData()
{
    ...
    treasure_room_chance = TREASURE_ROOM_CHANCE;
    empty_room_chance = EMPTY_ROOM_CHANCE;
    monster_room_chance = MONSTER_ROOM_CHANCE;
}
...
void GameHandler::GenerateNewRooms() {
    ...
    if (roomsExplored == 10) {
        ...
        printOnDescriptionCenterAndWait("The Player has explored more than 10 rooms - chance of treasure rooms has increased to " + to_string(treasure_room_chance) + "%", TREASURE_ROOM_COLOR);
    }
    else if (roomsExplored == 5) {
        treasure_room_chance += 5;
        empty_room_chance -= 5;
        printOnDescriptionCenterAndWait("The Player has explored more than 5 rooms - chance of treasure rooms has increased to " + to_string(treasure_room_chance) + "%", TREASURE_ROOM_COLOR);
    }
